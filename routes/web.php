...
Route::group(['prefix' => 'devis'], function () {
    ...
    //repondu
    Route::get('/repondu', [DevisController::class,'devisRepondu'])->name('devis.repondu');
    Route::get('/recu/{id}', [DevisController::class,'getDevisRecu'])->name('devis.recu');
    Route::get('/accepte/{id}', [DevisController::class,'accepteDevis'])->name('devis.accepte');
    Route::get('/accepteDevisRefuser/{id}', [DevisController::class,'accepteDevisRefuser'])->name('devis.accepteRefuser');

    //Accepter
    Route::get('/DevisAccepter', [DevisController::class,'devisAccepter'])->name('devis.devisAccepter');
    Route::get('/DevisObjetAccepter/{id}', [DevisController::class,'getObjetDevisAccepter'])->name('devis.devisObjetAccepter');

    //reduction
    Route::get('/reduction/{id}', [DevisController::class,'reductionDevis'])->name('devis.reduction');
    Route::get('/getAllObjetReduction/{id_devis}', [DevisController::class,'getAllObjetAttenteReduction'])->name('devis.allObjetReduction')->middleware('auth');

    //refuser
    Route::get('/refus/{id}', [DevisController::class,'refuserDevis'])->name('devis.refus');
    Route::get('/getAllObjetRefuser/{id_devis}', [DevisController::class,'getAllObjetAttenteRefuser'])->name('devis.allObjetRefuser')->middleware('auth');

    //Suppression devis
    Route::get('/supprDevis/{id_devis}', [DevisController::class,'supprimerDevis'])->name('devis.deleteDevis');
