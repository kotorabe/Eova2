...
@section('content')
    <main id="main">
        <div class="progress">
            <div class="progress-bar bg-success" role="progressbar" style="width: 95%" aria-valuenow="25" aria-valuemin=""
                aria-valuemax="100"></div>
        </div><br>
        <div class="container">
            <form action="{{ route('devis.envoie_devis') }}" method="POST">
                @csrf
                <h1>Veuillez insérer tous vos biens.</h1>
