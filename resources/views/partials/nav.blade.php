...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item livraison">
            <a class="nav-link collapsed livraison" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-truck"></i><span>Livraison</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="tables-nav" class="nav-content collapse livraison" data-bs-parent="#sidebar-nav">
                <li class="nav-item voir">
                    <a class="list livraison"  href="{{ route('livraisonb.liste') }}">
